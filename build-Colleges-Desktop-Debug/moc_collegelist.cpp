/****************************************************************************
** Meta object code from reading C++ file 'collegelist.h'
**
...
#include "../Colleges/collegelist.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'collegelist.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CollegeList_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CollegeList_t qt_meta_stringdata_CollegeList = {
    {
QT_MOC_LITERAL(0, 0, 11) // "CollegeList"
...
QT_INIT_METAOBJECT const QMetaObject CollegeList::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_CollegeList.data,
